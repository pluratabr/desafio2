...
namespace ApplicationRestTest\Controller;

use ApplicationRestTest\Bootstrap;
use ApplicationRest\Controller\FileController;
...
class FileRestControllerTest extends PHPUnit_Framework_TestCase
{
